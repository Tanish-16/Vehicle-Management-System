...
public class DriverSignUp extends javax.swing.JFrame {
    ...
    public DriverSignUp(String user,String name,String age,String pass,String cnic,String contactNo) {
...
if(checkCar.isSelected())
{
        ...
        DriverCar driver=new DriverCar(name,age,user,pass,"Car",cnic,contactNo);
        driver.addDriver();
...
else if(checkBus.isSelected())
{
    ...
    DriverBus driver=new DriverBus(name,age,user,pass,"Bus",cnic,contactNo);
        driver.addDriver();
        type=checkBus.getText();
    Bus bus=new Bus();
   int result;
...
else if(checkRickshaw.isSelected())
{
    ...
    DriverRickshaw driver=new DriverRickshaw(name,age,user,pass,"Rickshaw",cnic,contactNo);
        driver.addDriver();
